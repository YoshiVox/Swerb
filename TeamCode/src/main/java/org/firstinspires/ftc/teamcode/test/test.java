...
@Config
@TeleOp(name = "position", group = "test")
public class test extends OpMode {
    ...
    public void init() {
        ...
        efl = hardwareMap.get(AnalogInput.class, "fl_encoder");
        fl = hardwareMap.get(ServoImplEx.class, "fl_servo");
        fl.setPwmRange(new PwmControl.PwmRange(505, 2495));

        efr = hardwareMap.get(AnalogInput.class, "fr_encoder");
        fr = hardwareMap.get(ServoImplEx.class, "fr_servo");
        fr.setPwmRange(new PwmControl.PwmRange(505, 2495));

        ebl = hardwareMap.get(AnalogInput.class, "bl_encoder");
        bl = hardwareMap.get(ServoImplEx.class, "bl_servo");
        bl.setPwmRange(new PwmControl.PwmRange(505, 2495));

        ebr = hardwareMap.get(AnalogInput.class, "br_encoder");
        br = hardwareMap.get(ServoImplEx.class, "br_servo");
