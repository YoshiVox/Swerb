...
@Config
@TeleOp(name = "Pod Test", group = "test")
public class podTest extends OpMode {
    ...
    public void init() {
        ...
        mfl =hardwareMap.get(DcMotorEx.class, "fr_motor");
        efl = hardwareMap.get(AnalogInput.class, "fr_encoder");
        fl = hardwareMap.get(ServoImplEx.class, "fr_servo");
